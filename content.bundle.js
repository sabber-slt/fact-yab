...
/* harmony import */ var _assets_res_cross_svg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../assets/res/cross.svg */ "./assets/res/cross.svg");
...
function copyTextToClipboard(text) {
  var copyButton = document.querySelector("#hover");
...
function createContainer() {
  return ce({
    tag: "div",
    props: {
      className: "fact-gpt-container"
    },
    children: [{
      tag: "div",
      props: {
        className: "min-w-[30%]  max-h-[80%] max-w-[30%] fixed right-4 top-8 flex flex-col items-center justify-center rounded-lg bg-white shadow-md"
      },
      children: [
      // heading
      {
        tag: "div",
        props: {
          className: "flex h-[40px] w-full items-center justify-between rounded-t-lg bg-gray-200 px-4"
        },
        children: [{
          tag: "div",
          props: {
            id: "fact__heading-text",
            className: "text-xl font-black text-gray-700 flex items-center justify-center h-full w-full whitespace-nowrap"
          }
        }, {
          tag: "img",
          props: {
            id: "fact__close-button",
            className: "h-[24px] w-6 cursor-pointer rounded-lg hover:bg-sky-200",
            src: _assets_res_cross_svg__WEBPACK_IMPORTED_MODULE_0__,
            alt: "close"
          }
        }]
      },
      ...
      // body
      {
        ...
        children: [{
          ...
          props: {
            id: "fact__body",
            className: "text-3-xl flex flex-col whitespace-pre-line text-gray-700 font-bold"
          }
        }]
      }]
    }]
...
async function run() {
  ...
  if (!shadowRoot.querySelector(".fact-styles")) addStylesheet(shadowRoot, "styles.css", "fact-styles");
  ...
  const innerContainerHeading = container.querySelector("#fact__heading-text");
  innerContainerHeading.innerHTML = "<p>Fact Yab</p>";
  const innerContainerBody = container.querySelector("#fact__body");
  innerContainerBody.innerHTML = "<p>لطفا صبر کنید</p>";
  const closeButton = container.querySelector("#fact__close-button");
  ...
  port.onMessage.addListener(function (msg) {
    if (msg.answer) {
      ...
      innerContainerBody.innerHTML = '<p>لطفا وارد وب سایت شوید <a href="https://chat.openai.com" target="_blank">chat.openai.com</a></p>';
    } else {
      innerContainerBody.innerHTML = "<p>خطا</p>";
    }
  });
  port.postMessage({
    content
...
"use strict";
module.exports = "data:image/svg+xml;base64,";
